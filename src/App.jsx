...
import "./App.css";
import "./static/tailwind/exports.css";
...
function App() {
  return (
    <>
      ...
      <h1
        className="!text-[25px] p-4 btn xs:mx-4 mx-12"
        style={{ fontFamily: "Protest Riot" }}
      >
        Vite + React + Tailwind
      </h1>
      <div className="card">
        <p className="bg-blue-700 mx-8 rounded-lg p-4 text-white">
          Make changes to <code>src/App.jsx</code> to start building
        </p>
      </div>
      <Attributes />
    </>
